...
class MyGame(arcade.Window):
    ...
    def on_draw(self):
        ...
        list_couleur = [arcade.color.BLUE, arcade.color.APPLE_GREEN, arcade.color.RED, arcade.color.PURPLE, arcade.color.DEEP_PINK, arcade.color.DEEP_LEMON, arcade.color.ORANGE]
        arcade.start_render()
        for _ in range(20):
            arcade.draw_circle_filled(random.randint(20, SCREEN_WIDTH), random.randint(20, SCREEN_HEIGHT), 20, random.choice(list_couleur))
